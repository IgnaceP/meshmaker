...
class pymesh:
    ...
    def writeGeoFile(self, filename, cell_size = 250, spline_max_len = False, inner_rings = True, include_inner_rings = False,
                    ...
                    buffer_interpolation = 50, algo = 'Frontal-Delaunay'):
        """
        ...
        # if inner rings should be included but included in the domain
        if inner_rings == True and include_inner_rings == True:
            pass
    ...
    def getCoordinatesInnerHoleNodes(self, meshfile, n_inner_rings):
        """
        ...
        Args:
            ...
            n_inner_rings: (Required) integer representing the number of inner holes
        ...
        inner_rings = mesh_parts[-n_inner_rings:]
    ...
    def meshInnerHoles(self, Inner_ring_nodes_xy):
        """
        ...
        for xy in Inner_ring_nodes_xy:
                self.exter = xy
                writeGeoFile(self, filename, cell_size = self.holescellsize, inner_rings = False,  algo = self.algo)
